...
import SuppliersDelete from "../suppliers-delete.component/suppliers-delete.component";
import SuppliersEditButton from "../suppliers-edit.component/suppliers-edit-button.component";
...
const SuppliersList = (props) => {
  ...
  if (data == undefined) {
    ...
    return (
      <>
        <Link to="/purchase-order/suppliers/create">
          <CButton
            style={{
              marginBottom: "20px",
              marginLeft: "5px",
