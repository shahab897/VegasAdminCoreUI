...
import CategoriesDelete from "../categories-delete/categories-delete.component";
import CategoriesEditButton from "../categories-edit/categories-edit-button.component";
    ...
    return (
      <>
        ...
        <CRow>
          <CCol>
            <CCard>
              <CCardHeader>Product Categories</CCardHeader>
              <CCardBody>
                <CDataTable
                  items={data}
                  fields={fields}
                  ...
                  scopedSlots={{
                    ...
                    edit: (item) => {
                      return <CategoriesEditButton id={item.id} />;
                    },
                  }}
                />
              </CCardBody>
