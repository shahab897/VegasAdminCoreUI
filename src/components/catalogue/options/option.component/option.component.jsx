...
import OptionsDelete from "../options-delete.component/options-delete.component";
import OptionsEditButton from "../options-edit.component/options-edit-button.component";
...
const OptionsList = (props) => {
  ...
  const fetch_a = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}api/options`, config)
      .then((response) => {
  ...
  if (data == undefined) {
    ...
    return (
      <>
        <Link to="/catalogue/options/create">
          <CButton
            style={{
              marginBottom: "20px",
              marginLeft: "5px",
              ...
              <CCardBody>
                <CDataTable
                  ...
                  scopedSlots={{
                    delete: (item) => {
                      return (
                        <OptionsDelete id={item.id} setUpdated={setUpdated} />
                      );
                    },
                    edit: (item) => {
                      return <OptionsEditButton id={item.id} />;
                    },
                  }}
                />
              </CCardBody>
