...
// import WarehouseDelete from "../warehouse-delete.component/warehouse-delete.component";
// import WarehouseEditButton from "../warehouse-edit.component/warehouse-edit-button.component";

const CouponOptionsList = (props) => {
  const fields = [
    "name",
    "detail",
    "location",
    ...
    return (
      <>
        ...
        <CRow>
          <CCol>
            <CCard>
              <CCardHeader>Coupon Options</CCardHeader>
              <CCardBody>
                <CDataTable
                  items={data}
                  fields={fields}
                  ...
                  scopedSlots={
                    {
                      // delete: (item) => {
                      //   return (
                      //     <WarehouseDelete id={item.id} setUpdated={setUpdated} />
                      //   );
                      // },
                      // edit: (item) => {
                      //   return <WarehouseEditButton id={item.id} />;
                      // },
                    }
                  }
                />
...
export default CouponOptionsList;
