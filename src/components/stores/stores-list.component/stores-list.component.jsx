...
import StoresDelete from "../stores-delete.component/stores-delete.component";
import StoresEditButton from "../stores-edit.component/stores-edit-button.component";
              ...
              <CCardBody>
                <CDataTable
                  ...
                  scopedSlots={{
                    delete: (item) => {
                      return (
                        <StoresDelete id={item.id} setUpdated={setUpdated} />
                      );
                    },
                    edit: (item) => {
                      return <StoresEditButton id={item.id} />;
                    },
                  }}
                />
              </CCardBody>
